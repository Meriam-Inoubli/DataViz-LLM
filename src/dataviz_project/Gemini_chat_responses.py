...
def query_gemini(prompt: str,api_key) -> str:
    """
    Sends a request to Gemini (Google AI) API and returns the response.
    """
...
def gemini_select_best_visualization(data: pd.DataFrame, user_request: str,api_key) -> str:
    """
...
def gemini_generate_visualization_code(data: pd.DataFrame, visualization_types: str, user_request: str,api_key) -> str:
    """
...
def gemini_explain_visualization_choice(visualization_types: str, user_request: str,api_key) -> str:
    """
...
def chatbot_interface_gemini(api_key):
